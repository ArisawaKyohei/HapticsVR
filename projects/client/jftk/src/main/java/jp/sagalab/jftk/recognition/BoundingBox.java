...
public class BoundingBox implements Transformable<BoundingBox> {
   ...
   * @param _range        レンジ
   * @return バウンディングボックス
   * @throws IllegalArgumentException 中心点がNullである場合
   * @throws IllegalArgumentException 軸点列が2点未満である場合
   * @throws IllegalArgumentException 角点列が1点未満である場合
   * @throws IllegalArgumentException レンジがNullである場合
   */
