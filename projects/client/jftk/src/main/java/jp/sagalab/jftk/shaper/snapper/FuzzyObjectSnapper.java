...
public interface FuzzyObjectSnapper {
   ...
   * @return スナッピング結果
   */
  ShapedResult snap(RecognitionResult _recognition, GridSpace _gridSpace, SplineCurve _fsc);
   ...
   * @return スナッピング結果
   */
  Map<Fragment, ShapedResult> snap(Map<Fragment, RecognitionResult> _recognitions, List<Fragment> _fragments, GridSpace _gridSpace);
}
